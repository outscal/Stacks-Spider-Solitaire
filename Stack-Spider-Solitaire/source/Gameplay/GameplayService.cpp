...
void GameplayService::initialize() { level_controller->initialize(); }

void GameplayService::update() { level_controller->update(); }

void GameplayService::render() { level_controller->render(); }

void GameplayService::startLevel() { level_controller->startLevel(); }
...
int GameplayService::getScore() { return level_controller->getScore(); }

void GameplayService::destroy() { delete (level_controller); }
} // namespace Gameplay