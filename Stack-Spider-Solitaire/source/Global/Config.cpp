...
namespace Global
{
	...
	const sf::String Config::background_texture_path = "assets/textures/spider_solitaire_bg.png";

	const sf::String Config::level_background_texture_path = "assets/textures/level_bg.png";

	const sf::String Config::closed_card_texture_path = "assets/textures/cards/closed_card.png";
	...
	const sf::String Config::level_complete_sound_path = "assets/sounds/level_complete_sound.wav";
}